...
class DRQN(nn.Module):
    def __init__(self, observation_space=8, hidden_size=128, action_space=3, window_size=1, num_lstm_layers=1, dropout=0) -> None:
        super(DRQN, self).__init__()
        self.conv_layer = nn.Conv1d(observation_space, hidden_size, kernel_size=window_size)
        self.lstm_layer = nn.LSTM(input_size=hidden_size, hidden_size=action_space, num_layers=num_lstm_layers, batch_first=True, dropout=dropout)
...
class DLSTMQN(nn.Module):
    def __init__(self, observation_space=8, hidden_size=128, action_space=3, num_lstm_layers=1, dropout=0) -> None:
